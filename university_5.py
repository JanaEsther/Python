...
student_2 = Student("Josef Navrátil", fakulta_ekonomicka, 0)
...
if hasattr(student_2, "average_mark"):
    print("Má atribut average_mark.")
else:
    print("Nemá atribut average_mark.")
average_mark = getattr(student_2, "average_mark", "nemá average_mark")
print(average_mark)
